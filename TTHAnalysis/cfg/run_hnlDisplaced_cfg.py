...
if test == '1':
    ...
    comp = cfg.MCComponent( files = ["/afs/cern.ch/user/d/dezhu/workspace/public/10A42D2B-2274-E711-AA76-047D7B2E84EC.root"], name="HeavyNeutrino_trilepton_M-10_V-0p0001_2l_NLO_displaced" )
